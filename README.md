About opentelemetry-instrumentation-vertexai-feedstock
======================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-instrumentation-vertexai-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-instrumentation-vertexai-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-instrumentation-vertexai
# for installing globally
pixi global install opentelemetry-instrumentation-vertexai
```
...
It is possible to list all of the versions of `opentelemetry-instrumentation-vertexai` available on your platform:
...
```
pixi search opentelemetry-instrumentation-vertexai --channel conda-forge
```
